...
<p class="small">原告の通報は、当初、被通報者個人の問題として通報したものではありませんでした。上司に相談しても解決できなかったことにより、後になってから困ることがあるので、原告は、通報窓口担当者に対して、問題のあるプロセスは放置しないほうがいい旨を伝えていました。ですので、管理部門が社内周知で業務上誤りやすい箇所として注意喚起をすれば済む程度の内容の通報でした。
